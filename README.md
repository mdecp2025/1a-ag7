...
## 點擊 [此處是個人製作網站](https://41423117.github.io/Eternal-Realm-Games/)
...
### 改進了飛鳥生成邏輯：
  ...
  在生成飛鳥時記錄了飛鳥的方向 (fromLeft)，以便更準確地判斷何時飛出畫面


現在，當飛鳥飛到畫面盡頭並完全消失時，它們會從遊戲中移除，並且剩餘飛鳥數量會相應減少。當所有飛鳥都消失後（無論是被擊中還是飛出畫面），遊戲會結束並顯示分數。

## 11/13_16:12 我在飛鳥射擊遊戲添加了完整的歷史記錄功能：

### 歷史記錄按鈕：

  在難度選擇頁面的右下角添加了"歷史記錄"按鈕
